...
- KSPlayer：2.3.4
- MPVKit：源码适配保留；0.7.8 实验构建不链接二进制
...
5. 解压获得 `EmbyPlayerLab-0.7.8-<commit>-unsigned.ipa`，使用 TrollStore 覆盖安装。
...
- KTVHTTPCache 3.1.0 为 MIT；KSPlayer 2.3.4 及其 FFmpegKit 依赖按项目现有 GPL 说明处理。0.7.8 不链接 MPVKit。

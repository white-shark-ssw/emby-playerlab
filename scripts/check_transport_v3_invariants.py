...
require(project.count('MARKETING_VERSION: "0.12.6"') == 2, "project marketing version must be 0.12.6 in both settings scopes")
require(project.count('CURRENT_PROJECT_VERSION: "64"') == 2, "project build number must be 64 in both settings scopes")
...
require("Audit v0.12.6 frontier rescue regressions" in validate_workflow and "check_v0126_frontier_rescue.py" in validate_workflow, "Validate Source must enforce v0.12.6 regressions")
...
require('IPA_NAME="EmbyPlayerLab-0.12.6-${GITHUB_SHA::7}-unsigned.ipa"' in build_workflow, "unsigned IPA filename must identify v0.12.6")

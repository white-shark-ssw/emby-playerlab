...
require('RELEASE_TAG="v0.12.6-build64-dev"' in build, "versioned release tag mismatch")
require('RELEASE_IPA="EmbyPlayerLab-v0.12.6-build64-${GITHUB_SHA::7}-unsigned.ipa"' in build, "versioned release IPA mismatch")

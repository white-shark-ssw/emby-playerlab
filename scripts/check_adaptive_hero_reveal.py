...
require('proxy.frame(in: .named("emby-detail-scroll")).minY' in detail, "detail raw scroll probe is missing")
...
require('rawScrollProxy.frame(in: .named("emby-episode-picker-scroll")).minY' in picker, "episode picker raw scroll probe is missing")

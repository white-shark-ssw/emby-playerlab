...
_Last updated 2026-08-30: Build259 / 0.14.92 is target-device tested and proves shared 3×3 device-max refresh effectiveness: Library/Search display p50/p95 moved from ~16.67 ms to ~8.34 ms and obvious jitter is now difficult to see. A residual EX-vs-OnePlayer fine-grained curve-quality gap remains. Build260 / 0.14.93 preserves high refresh and measures per-display native deceleration continuity; CI/IPA verified, target-device pending. Search Build256 remains stable/merged and protected._

...
_Last updated 2026-08-30: Poster Build266 / 0.14.99 is now the current exact-source CI/IPA-verified A/B candidate, directly based on target-device-tested Build263. Build263 remains the real-device severe-gap authority: fixed-item severe25/33 tails strongly overlap high-speed poster-cell lifecycle bursts, usually with image publication. Build266 removes only unused loader `isLoading` publications from shared 3×3 `V3PosterCard(width == nil)` cells; image loading/publication, Search Build256 semantics and P0 playback/transport contracts remain protected. Target-device Build266 A/B is pending._
...
Build266 / 0.14.99 exact source `957e88dcdc408e537d63b083d0f30e4b1157b1dc`, Draft PR #273, directly extends Build263 with one narrow behavioral A/B: shared 3-column `V3PosterCard(width == nil)` cells no longer publish loader `isLoading` changes that they never render, while actual image loading/cache/decode/network/publication and all non-grid callers remain unchanged. Exact Build263→266 net scope is five paths. Xcode 16.4 Release run/job `33320334963 / 99281058534` passed; artifact `9734732730`, digest `sha256:eddba76a1829492720a77107938f5b4b23ef2c2854ac3605e5f3a5f812d13db0`; IPA SHA `8130bed5dc90f51f257343e24e24a82a902582ecf4c41c9bcb858f1fdaa83901`; source ZIP SHA `cb1b2fe1e85ffc4f61c75c126e094d210ee47e91161db53836e291898338b876`; bundle/version/build/MinOS independently verified as `com.embyplayerlab.app / 0.14.99 / 266 / 15.0`. Evidence: Code/CI/IPA verified; target-device pending; not stable.

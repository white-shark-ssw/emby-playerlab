...
| **Build229 / 0.14.62** | Library presentation snapshot persistence off MainActor | **CI/IPA verified; target-device pending; not stable.** Exact source `f5e3e3eb144578c863b172e3bd3a1aa13e5c2177`; exact Build228→229 delta is five paths only. Library state snapshot capture remains MainActor-owned, while object→JSON conversion, JSON serialization and atomic disk write execute on one serial utility queue and are awaited in order. Favorites persistence/cache schema/image policy/Home owners/P0 remain unchanged. Run/job `33156266871 / 98799654927`; artifact `9679803873`; artifact SHA-256 `8b301f7644f0dfb7e1fb80dba78069f870123c663ba5b323edc93a1e88f067b2`; IPA SHA-256 `49efcb8766cc9414a3f35e3d8fe75a04eaf6adf2ba86a40f526a5e53c40acd4c`; source ZIP SHA-256 `1de13e01617a575bf5b204e9dd546af443b8a7fdf79003e3eba1399edfb06e5a`; OnePlayer 0.14.62 (229), MinOS 15.0 independently verified. |

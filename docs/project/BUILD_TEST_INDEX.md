...
| **Build282 / 0.15.15** | Full carousel tree + active Pan callback-load isolation (`TREE PANLOAD`) | **Exact-source CI/IPA verified; target-device pending; diagnostic-only, not stable.** Initial source `9babebb...` failed run/job `33410468349 / 99548472740` at Swift compile because the new `UIViewRepresentable` lacked required `updateUIView`. Minimal fix source `58801ef0acc6084c3168e8d7635a1258925cc382` adds only that no-op protocol method after the diagnostic implementation; corrected run/job `33425378615 / 99597549081` succeeds. Artifact `9770646338`, digest `sha256:a8bb976eb2b8889f713357168797c1b144c35511d2b37ea8f22800f7b2876a8e`; IPA SHA `3ce933d6d380472fc0dec5aeadeda45d68008a3a37bc86ff48a335437f7d70cd`; source ZIP SHA `fab24ca52fd5a280d2051455537490b8cf12d223f973f0f7542a94e72a652ed6`; `0.15.15 (282)` / MinOS 15.0 independently verified; Draft PR #285. |

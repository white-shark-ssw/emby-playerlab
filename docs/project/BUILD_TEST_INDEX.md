...
| **Build259 / 0.14.92** | Shared 3×3 high-refresh A/B | **CI/IPA verified; target-device pending; not stable.** Exact source `39168e560d7e626557de8ebde6a88a5d38b3478b`; run/job `33304743577 / 99239168487`; artifact `9730129850`; IPA SHA `6d257396ba7a77178e62535c5dd04db58621ea25cf4a30e7e9bf415c7628a18a`; source ZIP SHA `dd121c94b7392abf647ec5471506a6dec903652c7f7f68a19f29ac567660710a`; MinOS 15.0. Reuses the existing cadence display link to request 80→device-max only during real 3×3 drag/deceleration; no Search/Grid/image/paging/Player/Transport contract change. |

...
| **Build219 / 0.14.52** | Aether manual multi-engine comparison candidate | **CI/IPA verified; real-device pending; not stable.** AetherEngine 6.50.0 is manually selectable while MPV remains default/automatic authority. Exact source `b1a06cb2b3dc9cf715fc5d49a7b324780aa23981`; Xcode 26.3 run/job `33096553966 / 98602865604` success; artifact `9656814369` (`sha256:f2e984c56ebf1b74a7eaf39ff43f08cee2e9a0edaa0ae65d6406d2fefd2fc75a`); IPA SHA-256 `8df11d2db597fd6841a3708976824b21879ee0d47257c1766d1704cc4196d06d`; source ZIP SHA-256 `61148b209d543c233502c8412f9448fffa143a97f5753c25595626c72b3e31e4`; MinOS 16.0. Aether uses existing UnifiedTransport exact-byte IOReader demand; no time→byte approximation, NAS relay, automatic fallback or PiP redesign. |

| **Build222 / 0.14.55** | Aether per-read seek-authority churn correction | **CI/IPA verified; corrective real-device retest pending; not stable.** Exact runtime fix `6f65f6a562c2f4af8a7720b33eb56d4b14b071bd` removes `confirmConcretePlaybackByte` from ordinary Aether sequential reads while keeping exact-byte `IOReader.seek()` / recovery reprioritization. Exact source `224199f90d12b39367ae7981463aedd70cdbfe2d`; Xcode 26.3 run/job `33103909150 / 98628547449` success; artifact `9659820803` (`sha256:98e3c51177a4803ae0cbefb91d9584a1373b4d6946e2396901e6de475a73252b`); IPA SHA-256 `a7566dc53a60880096a41ee36bf3eab1dd43f14e2ff4a9b86c1a78372a7af660`; source ZIP SHA-256 `8def2320dc5190b6f76bbfc6147a2d1f6d89c7c9821446e259f59d418116e923`; MinOS 16.0. Build219 device evidence was accurate Seek with severe adapter-induced Range cancellation churn; Build222 must be device-tested before attributing the remaining latency to Aether itself. |

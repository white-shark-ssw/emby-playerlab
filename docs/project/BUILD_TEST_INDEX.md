...
| **Build279 / 0.15.12** | Real-carousel standard Pan input A/B | **Target-device tested; recognizer-type-only replacement rejected; not stable.** Screen-off HUD: `CAROUSEL≈90 / CAROUSEL PAN≈90 / corrected TOUCH≈80`. App log shows 67 real-carousel Pan sessions with ~6.26 ms weighted callback interval and 101 corrected raw-touch sessions at ~8.25 ms, yet presented FPS remains below 120. Pan density alone is insufficient. Exact source `94f7a4ba5aa5bfdd3beb724e216015141dfc50b7`; run/job `33377860245 / 99443301805`; artifact `9752649942`; IPA SHA `36f17a02a0deddbae593f137d455cba3d22849bf28f00c0fafeb755b620abf9b`; MinOS 15.0. PR #283 closed unmerged. |
| **Build281 / 0.15.14** | Equal-refresh direct Pan vs frame-latched latest-real-input publication | **Target-device tested; frame-latching rejected as sufficient; not stable.** Screen-off result: `CAROUSEL≈90 / CAROUSEL PAN≈90 / CAROUSEL PAN LATCH≈90`. The latch executed and changed publication cadence but did not improve final HUD, so latest-real-input frame alignment alone is insufficient. Exact source `a0bb823f81742c7f08908c0465809a41f9e22b3b`; run/job `33398830817 / 99509848648`; artifact `9760543570`, digest `sha256:6af8d484a4c5782eee6d46f670a2091f715b06c28e0d044ed2517af746213c4f`; IPA SHA `4357afce03a6e35ede340a20d91f589f110389302145048073e0913bae8dfadd`; source SHA `23228a1f084d4d0c46c452f8c8bde2ef9145d3164d6c6f230b2d82e526716c16`; MinOS 15.0. PR #284 closed unmerged. |
| **Build282 / 0.15.15** | Full carousel tree + active Pan callback-load isolation (`TREE PANLOAD`) | **Target-device tested; Pan-load-only hypothesis rejected; sustained-control gate pending; diagnostic-only, not stable.** Initial source `9babebb...` failed compile only because the new `UIViewRepresentable` lacked required `updateUIView`; minimal fix exact source `58801ef0acc6084c3168e8d7635a1258925cc382` adds the no-op protocol method. Corrected run/job `33425378615 / 99597549081` succeeds; artifact `9770646338`, digest `sha256:a8bb976eb2b8889f713357168797c1b144c35511d2b37ea8f22800f7b2876a8e`; IPA SHA `3ce933d6d380472fc0dec5aeadeda45d68008a3a37bc86ff48a335437f7d70cd`; source ZIP SHA `fab24ca52fd5a280d2051455537490b8cf12d223f973f0f7542a94e72a652ed6`; MinOS 15.0. Screen-off target-device result: both `TREE FULL` and `TREE PANLOAD` initially reach 120 FPS but sustained motion can decay to ~50, so active Pan callback load alone is not causal evidence. Next compare same-package sustained `DISPLAYLINK` and `SWIFTUI` controls before new runtime instrumentation. Draft PR #285 remains unmerged. |
| **Build284 / 0.15.17** | Home in-process REF↔TREE crossover | **Code/CI/IPA verified; target-device pending.** Build282 manual scope-HUD attribution is rejected after same-package runs changed from 120 to ~90 across force-quit/relaunch. Exact source `942e7b77a0c344dd7b797b9e7a6978c212bf9b03` changes only AppIdentity + frame-pipeline probe from Build282. One continuous device-max DisplayLink alternates 15 s REF and real TREE load for three within-process pairs. Run/job `33554542393 / 100012028969`; artifact `9818916696`; IPA SHA `61c2f566739ff5c95b5ee2de394125ac93ffd99f5c2e8557416e29c1e485a3e0`; MinOS 15.0. Stable ❌. |
...
| **Build276 / 0.15.9** | Native Library 3×3 per-frame tail attribution | **Target-device diagnostic tested; visible twitch reproduced; append-correlated severe-tail established; not stable.** Exact source `6f56370f5990637052140fdcd0adf5e7f3428550`; former Draft PR #280 closed without merge; run/job `33336185686 / 99323381399`; artifact `9739134706`; IPA SHA `76236158b6e2e5e5154696014dbb22fb41b6b6de6fb2ec42287f49e380af597a`; source ZIP SHA `ff265b80f1b5b727ba34a4c97ef67cf2dac2402ea137b809b26342c207e7b687`; MinOS 15.0. `OnePlayer-App-1788125796.log` captures seven >=25 ms display gaps. Five +60 page appends correlate 1:1 with 25.96/41.71/52.16/58.33/60.12 ms gaps at 120/180/240/300/360 items, but measured batch begin→end is only 1.22–3.52 ms, so the batch call itself is not a sufficient cause. One same-ID visible-host reconfigure correlates with 66.91 ms and one 64.84 ms gap remains untracked. |
| **Build278 / 0.15.11** | Library persistence frame-tail timing | **Target-device diagnostic tested; synchronous full-Library persistence proven as a major pagination-tail contributor; not stable.** Exact source `6ff8113d9c45dfae6d745afa98b4a04a3956cf33`; PR #281 closed without merge; run/job `33337500594 / 99326940412`; artifact `9739532909`; IPA SHA `e30ca0a0477dfe1e12192c7e0d630328049be78138a65b947743803e3d55d2ea`; MinOS 15.0. Ten accepted +60 states from 120→660 items show 38.31→94.66 ms snapshot totals followed 1–8 ms later by 49.96→108.33 ms display gaps, correlation ≈0.991; fixed/no-append 540–660-item sessions stay near 119–120 Hz with zero >=25 ms gaps. Serialization dominates. This proves the pagination-adjacent contributor, not every historical hitch family. |
| **Build280 / 0.15.13** | Off-main Library presentation persistence A/B | **Target-device pagination fix positive; cached-first regression user-positive; not a universal 3×3 stable claim.** Exact source `531d7f53c55e1e3cff44069e9bce3193ac94749a`; run/job `33390236717 / 99481947293`; artifact `9757238604`; IPA SHA `e0b71190621671767b73cd95da63e733640ce2e2acfba9945f6178f6d12ac769`. `OnePlayer-App-1788190813.log` shows all persistence `main_thread=0` and clean 60→775 pagination with zero >=25 ms pagination gaps despite snapshot totals up to 267.76 ms. User then force-quit/relaunched and reported cached-first Library behavior normal. Follow-up `OnePlayer-App-1788191685.log` confirms a fresh launch and continued ordered off-main writes; no dedicated cache-load timing marker. |
| **Build283 / 0.15.16** | Restore native Library detail push animation after native UICollectionView migration | **Target-device navigation and pagination regression positive; broader poster task remains Active.** Exact source `39014a03e2681aed3647bdd6d7d7b1c82b8cc4f6` is directly parented by Build280 and keeps the hidden `NavigationLink` mounted so the same selection binding transitions false→true; no custom push/second navigation owner. Xcode 16.4 run/job `33412757299 / 99556026814`; artifact `9765884301`, digest `sha256:555ba6cc5c2859fbc8ad8a20fd1784eaf520ff5e4c4d235b9f10c4273b8f24a0`; IPA SHA `472b543f679f5db3932195c2abad8d882e78610172ecbe703fc75947c44e5655`; source ZIP SHA `c364da8ba7c7552feabb2b4375354f42472d7f88249fc77b29485ef9b3dbc40f`; MinOS 15.0. User confirms normal detail entry on target device. `OnePlayer-App-1788197938.log`: Library 60→660, 19.62 s, 118.34 Hz, p95 8.70 ms, p99 17.85 ms, max 25.02 ms, one >=25 ms / zero >=33.3 ms; sole 25.02 ms frame overlaps insert, while all persistence is `main_thread=0` with snapshot total up to 208.87 ms. User reports no visible twitch. Evidence: Code ✅ / CI ✅ / IPA ✅ / real-device navigation ✅ / real-device pagination regression ✅ / universal fixed-item smoothness not claimed. |

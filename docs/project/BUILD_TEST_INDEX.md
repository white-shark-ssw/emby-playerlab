...
| **Build266 / 0.14.99** | Shared 3×3 unused loading-state publication A/B | **Exact-source CI/IPA verified; target-device pending; not stable.** Exact source `957e88dcdc408e537d63b083d0f30e4b1157b1dc` directly extends target-device-tested Build263 and changes only five paths. Shared `V3PosterCard(width == nil)` 3-column cells stop publishing loader `isLoading` changes they do not render; actual image load/cache/decode/network/publication and non-grid callers remain unchanged. Run/job `33320334963 / 99281058534`; cleanup `99281458852`; artifact `9734732730`, digest `sha256:eddba76a1829492720a77107938f5b4b23ef2c2854ac3605e5f3a5f812d13db0`; IPA SHA `8130bed5dc90f51f257343e24e24a82a902582ecf4c41c9bcb858f1fdaa83901`; source ZIP SHA `cb1b2fe1e85ffc4f61c75c126e094d210ee47e91161db53836e291898338b876`; bundle `com.embyplayerlab.app`, version/build `0.14.99 / 266`, MinOS 15.0 independently verified. Draft PR #273. |

...
| **Build280 / 0.15.13** | Off-main Library presentation persistence A/B | **Code/CI/IPA verified; target-device pending; not stable.** Exact source `531d7f53c55e1e3cff44069e9bce3193ac94749a`; Draft PR #282; exact five-path scope/checker; run/job `33390236717 / 99481947293`; cleanup `99482802350`; artifact `9757238604`, digest `sha256:9b2d096e3c5d5909d17d3e9c875390cc2de81a3c50ef5158b7afcf3e56620111`; IPA SHA `e0b71190621671767b73cd95da63e733640ce2e2acfba9945f6178f6d12ac769`; source ZIP SHA `7f23b8bd788a79b2ee71558835826c453440fdabaca47f082ce12a0604e114c5`; MinOS 15.0. Moves full Library snapshot object-build/JSON serialization/atomic write off MainActor onto one serial utility queue while awaiting ordered completion; no coalescing or pagination/container/image/Search/Home/P0 change. Real-device acceptance specifically requires the Build278 pagination 50–100 ms severe-tail family to reduce/disappear with `main_thread=0`. |

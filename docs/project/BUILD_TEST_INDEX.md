...
| **Build278 / 0.15.11** | Library persistence frame-tail timing | **Exact-source CI/IPA verified; target-device pending; diagnostic-only; not stable.** Directly extends Build276 with exactly four changed paths and preserves native collection/pagination/cache behavior. Adds timing for full Library snapshot object construction, JSON serialization, atomic write, byte size and total persistence duration because exact source performs this work synchronously on the MainActor after each accepted page. Exact source `6ff8113d9c45dfae6d745afa98b4a04a3956cf33`; Draft PR #281; run/job `33337500594 / 99326940412`; cleanup `99327426771`; artifact `9739532909`, digest `sha256:7cb116b3cd686e9dd7f0bf47718ed1cf967d72cd057ef902fd1ae0ebadf47182`; IPA SHA `e30ca0a0477dfe1e12192c7e0d630328049be78138a65b947743803e3d55d2ea`; source ZIP SHA `337422655a39a75af0d13d928857a094acf9f92564c9785327e73b8e633f2997`; MinOS 15.0. No async persistence or Build213 semantic change until target-device timing proves causality. |

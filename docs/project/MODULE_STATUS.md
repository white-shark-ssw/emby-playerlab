...
| Other product modules | Active parallel work | Build178 remains the accepted runtime baseline. Build182 detail and Build183 carousel are separate active candidates with unique Build identities and no current file/state-owner overlap. |

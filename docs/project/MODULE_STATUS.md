...
| Home carousel interaction | **Active — Build200/201 candidate line** | Build198 real-device retained the single UIKit lifecycle owner but rejected minimum visual smoothness. Build200/201 are independent carousel visual-mapping candidates under `DEV-home-carousel-drag-smoothness`; keep that checkpoint authoritative and do not reuse their build identities here. |
...
| Other product modules | Active parallel work | Build199 / 0.14.32 remains the accepted overall runtime baseline. Home-carousel Build200/201 and poster-scroll Build202 are separate Active candidates with independent branches/evidence; none is implied accepted by Build199. |

...
| Other product modules | Active parallel work | Build195 / 0.14.28 is the accepted overall runtime baseline on `main`. Build196 / 0.14.29 remains the independent Add/Edit Emby cached-first/password candidate with CI/IPA complete and target-device validation pending. Build193 remains the rejected/investigation carousel line. |

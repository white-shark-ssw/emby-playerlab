...
- **Current candidate**: OnePlayer `0.14.99 (266)`; directly based on target-device-tested Build263 exact source `bff02ea8e76217b1fe07c298d8b9058b2db1fd08`; exact Build263→266 net scope is five paths; source checker passed; exact-source Xcode 16.4 Release CI run/job `33320334963 / 99281058534` passed; artifact `9734732730`; IPA/source package independently verified; target-device pending; not stable. Build265 / 0.14.98 is owned by parallel Home-carousel branch `perf/home-carousel-image-analysis-dedupe-build265`; the poster Build265 attempt never committed product code and is retired for attribution.

...
- Code written: yes.
- Narrow source/static contracts: passed locally before candidate CI.
- CI / IPA / real-device: pending at changelog creation time; do not interpret this file as runtime acceptance.

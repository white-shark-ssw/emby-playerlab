...
- Build181 replaces the detail-page Build180 identity only because a parallel homepage carousel task also occupied 0.14.13 / Build180. The detail feature code is unchanged from the already Release-compiled detail candidate.

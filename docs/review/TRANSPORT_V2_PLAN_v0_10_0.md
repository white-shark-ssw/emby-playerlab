...
4. Start the second prefetch lane only after a short primary warmup; keep the primary connection alive during playback starvation and yield only the secondary lane.

...
- KTV observability in 0.8.0: public cache-item total bytes + public `zones.count`; exact zone offsets remain deferred until a verified fixed KTV observability adapter is added

...
- Local validation: Swift parser for all sources; targeted Swift 5 typecheck for MediaTransportSession and transition support types; plist/YAML/JSON/shell validation; manifest, patch-application and archive verification.
